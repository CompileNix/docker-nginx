...
- `<version>`, `1.31`, `1`, `latest`
- `<version>-extras`, `1.31-extras`, `1-extras`, `latest-extras`
- `<version>-slim`, `1.31-slim`, `1-slim`, `latest-slim`

## Container Image Variants
### Default (`<version>`, `1.31`, `1`, `latest`)
...
### Extras (`<version>-extras`, `1.31-extras`, `1-extras`, `latest-extras`)
...
### Slim (`<version>-slim`, `1.31-slim`, `1-slim`, `latest-slim`)
...
- Create / Update Docker Image Tags
    - ```sh
      ...
      docker image tag "${IMAGE_NAME}:${NGINX_VERSION}" "${IMAGE_NAME}:1.31"
      ...
      docker image tag "${IMAGE_NAME}:${NGINX_VERSION}-extras" "${IMAGE_NAME}:1.31-extras"
      ...
      docker image tag "${IMAGE_NAME}:${NGINX_VERSION}-slim" "${IMAGE_NAME}:1.31-slim"
