...
- `1.29.4`, `1.29`, `1`, `latest`
- `1.29.4-extras`, `1.29-extras`, `1-extras`, `latest-extras`
- `1.29.4-slim`, `1.29-slim`, `1-slim`, `latest-slim`

## Container Image Variants
### Default (`1.29.4`, `1.29`, `1`, `latest`)
...
### Extras (`1.29.4-extras`, `1.29-extras`, `1-extras`, `latest-extras`)
...
### Slim (`1.29.4-slim`, `1.29-slim`, `1-slim`, `latest-slim`)
